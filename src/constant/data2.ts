export const SPEAKER_DATA = [
  {
    ...
    time: "09:00 - 10:00",
    sessionSummary: "Injection Moulding Technique is a powerful therapeutic option in the restorative field, designed to improve both the aesthetics and function of teeth. It is a repeatable and predictable procedure that transforms a digital or analog wax-up into a definitive composite restoration using either a direct or indirect approach. The technique has been innovatively developed with the aid of a new index dedicated to the injection procedure, called the Customised Hybrid Index, published in IJED 2025 n1. It utilizes flowable or thermoviscous composites to restore the shape, surface, and texture of teeth by accurately replicating laboratory-defined wax-ups, tested with mock-ups before injection. The primary applications are in adhesive restorative cases, particularly additive procedures such as diastemas or erosion/abrasion, ranging from single restorations to multiple frontal elements or full-mouth adhesive rehabilitation. The technique is also strategic in orthodontic cases to define final volumes before tooth movement, and in periodontal cases with significant loss of support, allowing the closure of black triangles and splinting of mobile elements after appropriate surgical or non-surgical therapy. Overall, this approach offers numerous applications and represents an extraordinary therapeutic opportunity within a conservative and minimally invasive framework.",
    learningObjectives: [
  ...
  },
  {
    ...
    aboutSpeaker: "Dr. Gustavo Giordani is a specialist in Oral Maxillofacial Surgery and Traumatology, with a post-graduate degree in Implantology and Periodontics. He specialised in cosmetic surgery at a Fellowship in Belgium with Dr. Eric Van Dooren. Author of the book Smile Architecture - Building a brand, Interdisciplinary Aesthetic Dentistry - The Big Picture and several national and international scientific articles, Gustavo works as a clinician in his private clinic in São Paulo, Brazil and works in partnership with the biggest names in aesthetic rehabilitation in Brazil and world. He stands out as a national and international speaker, participating in the biggest events of aesthetic dentistry surgery. Graduated at Universidade Paulista - UNIP; Post Graduation on Oral and Maxilo Facial Surgery; Post Graduation on Implants and Periodontal Plastic Surgery; Fellowship International on Implants and Periodontal Surgery with Dr. Eric Van Dooren Antwerp - Belgium Implantes."
  },
  {
    name: "Dr. Ramon Gomez Meda",
    image: "/rgm.jpg",
    slug: "dr-ramon-gomez-meda",
    title: "Hard & Soft Tissue Management in the Esthetic Area to Achieve Predictable Results: From Class I to Class III",
    date: "SATURDAY 31ST JANUARY",
    time: "14:15 - 15:15 & 15:45 - 16:45",
    sessionSummary: "Minimally invasive procedures keep the vascularization of the alveolus avoiding scars and other esthetic complications. New development in periodontal procedures allow the clinician to reconstruct the hard and soft tissues in predictable ways. This lecture explains the diagnosis and digital protocol along with the prosthetic and periodontal planification in order to get predictable results with immediate implants in different clinical scenarios.",
    learningObjectives: [
