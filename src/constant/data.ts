...
export const TESTIMONIALS = [
  ...
  {
    name: "Dr Juerg Willi",
    para: "“My initial absolutely coincidental encounter with BAAD has - in hindsight now many years later - turned out to be a true turning point in my outlook on dentistry and the part I should be playing in it. I met an expert group of likeminded people, united in their believe that only a job properly done is a job worth doing.<br/>To be accepted by this group as equal (even though I was not) has been a huge incentive to do likewise and aspire to the same clinical standards. Excellence is not a skill, it is an attitude. Anybody who can live by this bonmot will easily find in BAAD not only encouragment and guidance, but also very good friends (even though they are called BAAD friends).”",
    reverse: true,
  },
  {
    name: "Thomas",
