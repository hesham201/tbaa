...
const MAP: Record<string, string> = {
  "aesthetic-wizardry-unlocking-the-chamber-of-secrets": "aesthetic-wizardry",
  "dentistry-beyond-pure-imagination-scientific-meeting-2019":
    "2019-dentistry-beyond",
};

async function listFolder(folder: string): Promise<string[]> {
  const dir = path.join(process.cwd(), "public", "galleries", folder);
