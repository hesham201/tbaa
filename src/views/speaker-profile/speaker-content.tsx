...
const SpeakerContent: React.FC<SpeakerContentProps> = ({ speakerId = "0" }) => {
  ...
  useGSAP(() => {
    ...
    const splitTitle = new SplitType("#speaker-title", {
      types: "words,chars",
    });
    ...
    <div id="speaker-content" ref={headerRef}>
          ...
          <Container>
            <div className="flex flex-col lg:flex-row-reverse items-center md:justify-between gap-6 md:gap-0">
              <div className="w-full md:w-[55%] px-6 flex flex-col justify-start md:pl-0">
                <p id="speaker-name" className="mb-4 text-primary text-2xl">
                  {" "}
                  {speaker.name}
                </p>
      ...
      <Container>
        ...
        <div className="py-8 mt-[250px]  lg:mt-0 relative">
          ...
          <div
            className="text-base mb-6 fade-in-up"
            dangerouslySetInnerHTML={{ __html: speaker.aboutSpeaker }}
          />
      ...
      <div className="py-8 bg-primary w-full">
        <Container>
          ...
          <div
            className="text-base mb-6 text-left fade-in-up"
            dangerouslySetInnerHTML={{ __html: speaker.sessionSummary }}
          />
      ...
      <Container>
        ...
        <div className="py-8 ">
          ...
          {speaker.learningAims && speaker.learningAims.length > 0 && (
            <>
              <h4 className="text-2xl mb-3 text-midnight font-medium fade-in-up">
                Aims
              </h4>
          ...
          {speaker.learningObjectives &&
            speaker.learningObjectives.length > 0 && (
              <>
          ...
          {speaker.keyLearningPoints &&
            speaker.keyLearningPoints.length > 0 && (
              <>
                <h4 className="text-2xl mb-3 text-midnight font-medium mt-6 fade-in-up">
                  Key Learning Points
                </h4>
                <ul className="space-y-4 pl-6 list-disc fade-in-up">
