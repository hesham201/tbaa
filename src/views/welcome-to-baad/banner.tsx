...
const Banner = () => {
  ...
  return (
    <div
      ...
      <Container>
        {/* Changed to flex-col on mobile, row on lg+ */}
        <div className="flex flex-col lg:flex-row gap-7 items-center">
          {/* TEXT SIDE (kept) */}
          <div className="flex flex-col gap-2 lg:gap-10 lg:order-2">
            {/* 1) HEADING FIRST ON MOBILE */}
            <h1
              className="text-primary mb-3 text-[30px] mt-2 lg:text-[50px]"
              id="home-h1">
              Welcome to BAAD 2026 – Where Excellence in Aesthetic Dentistry
              Meets Inspiration
            </h1>

            {/* 2) MOBILE-ONLY IMAGE BETWEEN HEADING AND PARAGRAPH */}
            <div className="lg:hidden min-h-[150px] w-full overflow-hidden">
          ...
          {/* DESKTOP IMAGE (kept, just hidden on mobile) */}
          <div className="hidden lg:block min-h-[200px] md:h-[460px] lg:h-[550px] w-[45%] shrink-0 overflow-hidden lg:order-1">
            <div className="video-main-div relative scale-x-0 h-0 overflow-hidden origin-top transition-all">
              <div className="absolute z-10 inset-0 h-full w-full bg-primary video-bg"></div>
              <div className="video-div-main relative">
                <img
